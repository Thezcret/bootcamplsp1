                ...
                <div class="card-body p-5">
                    <form action="/aspirasi/store" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="id" class="form-control bg-danger text-light fw-bold" readonly
                                value="{{ $no }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class=" container row d-flex justify-content-center">
                                <div class="col-12 bg-danger rounded-4 bg-gradient p-3">
                                    <div class="row ">
    ...
    <div class="row justify-content-center">
        <div class="col-12 mb-3">
            <nav class="navbar navbar-expand-lg bg-light shadow border-bottom rounded-4 p-lg-3 p-sm-0 p-md-3">
                <div class="container">
                    <a class="navbar-brand fw-bold text-danger fs-3" href="/aspirasi">Lihat Pengaduan</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 px-4  py-3">
                            ...
                            <form action="/aspirasi/feedback" method="POST" class=" p-2  rounded-2 text-center">
                                ...
                                <div class="btn btn-danger"> <input type="radio" required name="feedback" value="5"
                                        id="">
                                    <label class="form-check-label">
                                        5
                                    </label></div>
